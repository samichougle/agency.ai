  ...
  const workData = [
    {
      ...
      description:
        "We turn bold ideas into powerful digital solution that connect, engage and convert.",
  ...
  return (
    ...
    >
      <Title
        ...
        desc="From stratefy to execution, we craft digital solutions that move your businedd forward."
      />
